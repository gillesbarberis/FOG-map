...
- 88 of 96 entities now have coordinates: 79 sourced, reported or editorially set positions and 9 original positions marked `provided_unverified`. Eight entities remain unmapped where identity, current base or multiple locations need resolution. Public-source evidence, precision and research notes appear in the artist cards. See [the geography research register](research/artist-geography.md) for the complete source trail.
