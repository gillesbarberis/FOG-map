...
- All 95 entities have map coordinates: 87 sourced, reported or editorially set positions and 8 inherited atlas positions. Country and regional precision is retained where a city is not established. Cards show location names only; the [geography research register](research/artist-geography.md) retains evidence and editorial reasoning. WAV uses a Tokyo anchor with a Tokyo / Paris display and connections to both members; Asuna & Opitope uses Tokyo as an editorial inference.
